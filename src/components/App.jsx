...
function App() {
  ...
  let lSProffesionalProfile = "Lorem ipsum dolor sit amet consectetur adipisicing elit. Sequi inventore, quia consequuntur eos error eum nisi voluptate id tempore voluptatibus consectetur, laboriosam culpa quis dicta quasi officia officiis reprehenderit possimus?";
  let lSSchools = [{
    id: 0,
  ...
  if (localStorage.getItem("practicalExperience")) {
    lSPracticalExp = JSON.parse(localStorage.getItem("practicalExperience"));
  }
  ...
  const [professtionalProfile, setProfesstionalProfile] = useState(lSProffesionalProfile);
  ...
  return (
    <div className='main-window'>
      <button className='input-data-show-menu' onClick={toggleCVInput}>
        <svg xmlns="http://www.w3.org/2000/svg" width="2rem" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-6">
