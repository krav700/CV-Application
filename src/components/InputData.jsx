...
function School({ person, school }) {
    const dateFrom = dateOrganizer(
        new Date(school.dateFrom[0], school.dateFrom[1])
    );
        ...
        <form>
            <div className="school-block">
                ...
                <input
                    ...
                    value={school.title}
                    onChange={(e) =>
                        changeSchoolAttribute(e, school.id, "title", person)
                    }
                />
                ...
                <input
                    ...
                    value={dateFrom}
                    onChange={(e) =>
                        changeSchoolAttribute(e, school.id, "dateFrom", person)
                    }
                />
                ...
                <input
                    ...
                    value={dateTo}
                    onChange={(e) =>
                        changeSchoolAttribute(e, school.id, "dateTo", person)
                    }
                />
            </div>
        </form>
...
function Work({ person, work }) {
    const dateFrom = dateOrganizer(
        new Date(work.dateFrom[0], work.dateFrom[1])
    );
        ...
        <form>
            <div className="work-block">
                ...
                <input
                    ...
                    value={work.title}
                    onChange={(e) =>
                        changeWorkAttribute(e, work.id, "title", person)
                    }
                />
                ...
                <input
                    ...
                    value={dateFrom}
                    onChange={(e) =>
                        changeWorkAttribute(e, work.id, "dateFrom", person)
                    }
                />
                ...
                <input
                    ...
                    value={dateTo}
                    onChange={(e) =>
                        changeWorkAttribute(e, work.id, "dateTo", person)
                    }
                />
            </div>
        </form>
...
function InputData({ person }) {
    ...
    const [showProfessionaProfile, setShowProfesstionalProfile] =
        useState(false);
    ...
    return (
        <div className="input-data">
            <div
                className="general-section section"
                onClick={() => setShowGeneral(!showGeneral)}
            >
                <h1>General</h1>
                <button className="general-drow-button drow-button">
                    {showGeneral ? "⌃" : "⌄"}
                </button>
            </div>
            <div
                className={
                    showGeneral ? "general-dropdown" : "hide-general-dropdown"
                }
            >
            ...
            <div
                className="professional-profile-section section"
                onClick={() =>
                    setShowProfesstionalProfile(!showProfessionaProfile)
                }
            >
                <h1>Proffessional Profile</h1>
                <button className="pro-drow-button drow-button">
                    {showProfessionaProfile ? "⌃" : "⌄"}
                </button>
            </div>
            <div
                className={
                    showProfessionaProfile
                        ...
                        : "hide-professional-profile-dropdown"
                }
            >
                <textarea
                    id="pro-pro"
                    className="pro-pro-textarea"
                    value={person.professtionalProfile}
                    onChange={changeProPro}
                />
            </div>

            <div
                className="employment-history-section section"
                onClick={() => setShowEmploymentHistory(!showEmploymentHistory)}
            >
                <h1>Employment History</h1>
                <button className="employment-drow-button drow-button">
            ...
            <div
                className={
                    showEmploymentHistory
                        ...
                        : "hide-employment-history-dropdown"
                }
            >
                {person.practicalExp.map((work) => {
                    return <Work person={person} work={work} key={work.id} />;
                })}
                <button
                    className="add-organasation"
                    onClick={() => addNewWork(person)}
                >
                    +
                </button>
            </div>
            ...
            >
                <h1>Education</h1>
                <button className="education-drow-button drow-button">
                    {showEducation ? "⌃" : "⌄"}
                </button>
            </div>
            <div
